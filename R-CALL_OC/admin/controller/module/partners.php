...
class ControllerModulePartners extends Controller {
	...
	public function index() {
		$this->load->language('module/partners'); //подключаем наш языковой файл
        ...
        //в качестве файла представления модуля для панели администратора использовать файл partners.tpl
