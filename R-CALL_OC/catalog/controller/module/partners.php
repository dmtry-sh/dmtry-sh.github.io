...
class ControllerModulePartners extends Controller {
	public function index() {
		...
		$this->load->language('module/partners'); //подключаем любой языковой файл
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/partners.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/partners.tpl', $data);
		} else {
			return $this->load->view('default/template/module/partners.tpl', $data);
		}		
