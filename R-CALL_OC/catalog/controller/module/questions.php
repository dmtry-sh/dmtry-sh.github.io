...
class ControllerModuleQuestions extends Controller {
	public function index() {
		...
		$this->load->language('module/questions'); //подключаем любой языковой файл
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/questions.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/questions.tpl', $data);
		} else {
			return $this->load->view('default/template/module/questions.tpl', $data);
		}		
