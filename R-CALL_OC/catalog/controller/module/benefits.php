...
class ControllerModuleBenefits extends Controller {
	public function index() {
		...
		$this->load->language('module/benefits'); //подключаем любой языковой файл
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/benefits.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/benefits.tpl', $data);
		}	
	}
}?>