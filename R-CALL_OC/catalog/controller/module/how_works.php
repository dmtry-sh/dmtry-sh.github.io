...
class ControllerModuleHowWorks extends Controller {
	public function index() {
		...
		$this->load->language('module/how_works'); //подключаем любой языковой файл
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/how_works.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/how_works.tpl', $data);
		} else {
			return $this->load->view('default/template/module/how_works.tpl', $data);
		}		
